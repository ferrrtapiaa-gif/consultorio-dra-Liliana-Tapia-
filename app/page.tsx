      ...
      <header style={{ 
        ...
        <div style={{ maxWidth: '850px', margin: '0 auto', position: 'relative', zIndex: 2 }}>
          <h1 style={{ 
            ...
            Tu Consulta Médica 
             <br />Desde la Comodidad de tu Casa
          </h1>
          <p style={{ 
            fontSize: '1.35rem', 
            color: '#f1f5f9', 
      ...
      <section id="servicios" style={{ padding: '100px 20px', maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
          ...
          <div style={{ backgroundColor: '#fff', padding: '40px 30px', borderRadius: '20px', boxShadow: '0 4px 20px rgba(0,0,0,0.02)', border: '1px solid #e2e8f0', textAlign: 'center' }}>
            ...
            <div style={{ backgroundColor: '#fff', padding: '40px 30px', borderRadius: '20px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}>
            <div style={{ fontSize: '2.5rem', marginBottom: '20px', backgroundColor: '#f0f9ff', width: '70px', height: '70px', lineHeight: '70px' }}>🗂️</div>
            <h3 style={{ color: '#0f172a', marginTop: 0, fontSize: '1.35rem', fontWeight: '700' }}>Fichas Médicas</h3>
            <p style={{ color: '#64748b', lineHeight: '1.6', fontSize: '0.95rem', margin: 0 }}>Realizamos fichas médicas completas y personalizadas para que tengas toda tu información de salud al día.</p>
            </div>

            <div style={{ backgroundColor: '#fff', padding: '40px 30px', borderRadius: '20px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}>
            <div style={{ fontSize: '2.5rem', marginBottom: '20px', backgroundColor: '#f0f9ff', width: '70px', height: '70px', lineHeight: '70px' }}>📄</div>
            <h3 style={{ color: '#0f172a', marginTop: 0, fontSize: '1.35rem', fontWeight: '700' }}>Certificados</h3>
            <p style={{ color: '#64748b', lineHeight: '1.6', fontSize: '0.95rem', margin: 0 }}>Emisión rápida de certificados médicos digitales para trámites laborales, escolares o deportivos.</p>
            </div>
          </div>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '30px', textAlign: 'left', maxWidth: '600px', margin: '0 auto' }}>
            ...
            <div style={{ borderLeft: '3px solid #0ea5e9', paddingLeft: '15px' }}>
              ...
              <span style={{ fontSize: '1.1rem', fontWeight: '600' }}>Consultas de 20 minutos</span>
            </div>
            <div style={{ borderLeft: '3px solid #0ea5e9', paddingLeft: '15px' }}>
